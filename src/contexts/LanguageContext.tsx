...
const translations = {
  ...
  es: {
    ...
    ecoDesc: 'Nuestro buque es impulsado por energía eólica y solar, haciendo su viaje ambientalmente responsable.',
    ...
    readingCornerDesc: 'Acogedoras áreas de asiento perfectas para leer o conversar tranquilamente',
    ...
    suppliersDesc: 'Pague a sus proveedores internacionales de forma segura con nuestro confiable servicio de pago',
    ...
    specialInstructions: 'Instrucciones especiales o requisitos particulares',
    cancel: 'Cancelar',
    ...
    position: 'Puesto',
    positionApplyingFor: 'Puesto para el que está aplicando',
    ...
    supplyChainAnalyticsDesc: 'Información basada en datos para optimizar las operaciones de su cadena de suministro y reducir costos mientras mejora la eficiencia.',
    ...
    calculatorNote: 'Esta calculadora proporciona una estimación para el envío de palés en nuestros buques propulsados por viento. Los precios se basan en una tarifa de {rate} EUR por milla náutica. Nuestros buques ecológicos ofrecen costos 15% más bajos que los buques diésel, con una capacidad de 1,000 palés por buque. Contáctenos para cotizaciones de envío a granel.',
