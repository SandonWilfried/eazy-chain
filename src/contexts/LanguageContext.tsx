...
const translations = {
  ...
  es: {
    ...
    customsClearance: 'Solicitud de Despacho de Aduana',
    customsClearanceDesc: 'Servicios de despacho de aduana optimizados para acelerar sus envíos a través de controles fronterizos y puntos de control regulatorios.',
    ...
    airGroupage: 'Agrupación Aérea',
    oceanFreight: 'Flete Marítimo',
    oceanFreightDesc: 'Servicios de flete marítimo rentables para envíos de contenedores y grandes volúmenes de carga, incluidas opciones de consolidación.',
    oceanGroupage: 'Agrupación Marítima',
    ...
    moreCabinDesc: 'Explore más imágenes de nuestros alojamientos premium en camarotes',
    ...
    readingCornerDesc: 'Áreas de asiento acogedoras perfectas para leer o una conversación tranquila',
    ...
    suppliersDesc: 'Pague de forma segura a sus proveedores internacionales con nuestro confiable servicio de pago',
    ...
    tellUsAboutYourself: 'Háblenos sobre usted y por qué está interesado en este puesto',
    ...
    globalTradeConsultingDesc: 'Asesoramiento experto sobre regulaciones de comercio internacional, aduanas y cumplimiento para ayudar a su empresa a navegar en mercados globales.',
    ...
    sustainableShippingDesc: 'Opciones de envío ecológicas para reducir su huella de carbono y cumplir con estándares de cumplimiento ambiental.',
    weatherRoutingServices: 'Servicios de Rutas Meteorológicas',
    weatherRoutingServicesDesc: 'Planificación de rutas optimizada basada en pronósticos meteorológicos para garantizar viajes más seguros y reducir el consumo de combustible.',
    ballastWaterManagement: 'Gestión de Agua de Lastre',
    ballastWaterManagementDesc: 'Soluciones integrales para sistemas de tratamiento de agua de lastre para cumplir con regulaciones internacionales.',
    energyEfficiencyConsulting: 'Consultoría de Eficiencia Energética',
    energyEfficiencyConsultingDesc: 'Asesoramiento experto sobre reducción de consumo de energía y emisiones para sus operaciones de buques.',
    ...
    // Pallet Price Calculator
    palletPriceCalculator: 'Calculadora de Precio de Palés',
    ...
    selectPalletType: 'Seleccione tipo de palé',
    quantity: 'Cantidad',
    currency: 'Moneda',
    selectCurrency: 'Seleccione moneda',
    calculatePrice: 'Calcular Precio',
    estimatedShippingCosts: 'Costos de Envío Estimados:',
    perPallet: 'Por palé:',
    total: 'Total',
    pallets: 'palés',
    route: 'Ruta:',
    ...
    calculatorNote: 'Esta calculadora proporciona una estimación para el envío de palés en nuestros buques impulsados por viento. Los precios se basan en una tarifa de {rate} EUR por milla náutica. Nuestros buques ecológicos ofrecen costos 15% más bajos que los buques diésel, con una capacidad de 1,000 palés por buque. Contáctenos para cotizaciones de envío a granel.',
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [language, setLanguage] = useState<Language>(() => {
    ...
    // If browser language is one of our supported languages, use it
